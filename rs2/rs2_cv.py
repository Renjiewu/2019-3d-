...
def rs1_cv(img1,img2,img):
    ...
    l,r=find_p(roi1)
    r1=(340+r[0],r[1]+100)
    roib=img[r1[1]-8:r1[1]+8,r1[0]-8:r1[0]+8]
    l,r=find_p(roib)
    r3=(r[0]+r1[0]-8,r[1]+r1[1]-8)

    roi3=imgc[l1[1]+50:l1[1]+70,l1[0]:l1[0]+200]
    l,r=find_p(roi3)
    l2=(l1[0]+l[0],l[1]+l1[1]+50)
    roic=img[l2[1]-8:l2[1]+8,l2[0]-8:l2[0]+8]
    l,r=find_p(roic)
    l4=(l[0]+l2[0]-8,l[1]+l2[1]-8)
    
    roi4=imgc[r1[1]+50:r1[1]+70,r1[0]-200:r1[0]]
    l,r=find_p(roi4)
    r2=(r1[0]-200+r[0],r[1]+r1[1]+50)
    roid=img[r2[1]-8:r2[1]+8,r2[0]-8:r2[0]+8]
    l,r=find_p(roid)
    r4=(r[0]+r2[0]-8,r[1]+r2[1]-8)
    
    imgf=cv2.cvtColor(thr,cv2.COLOR_GRAY2BGR)
    cv2.circle(imgf,r3,5,(0,0,255),-1)
    cv2.circle(imgf,l3,5,(0,0,255),-1)
    cv2.circle(imgf,l4,5,(0,0,255),-1)
    cv2.circle(imgf,r4,5,(0,0,255),-1)
    
    #cv2.circle(roi1,r1,5,(255,255,255),-1)
